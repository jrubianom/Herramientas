...
int main(int argc, char** argv){
    ...
    //inicializacion del vector particulas y eventos en paralelo
    ...
    std::cout << "La velocidad cuadratica promedio final es " <<
        avg_speed(vec_particulas,N_particulas) << std::endl;
}
...
#pragma omp parallel
    {
        ...
        initial_conditionsp(SEED,N_particulas,vec_particulas,dbox, m, r,
                            vel_inicial, 0, 0,thid,nth);
        init_Events(Events,N_particulas,vec_particulas,thid,nth);
